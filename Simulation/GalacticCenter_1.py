...
s=Source()
s.add(SourceUniformCylinder(Vector3d(0,0,0), 20 * pc, 100 * pc))
s.add(SourceParticleType(nucleusId(1,1)))
s.add(SourceEnergy(100*TeV))
...
#Create output2
output2 = TextOutput("1_Secondaries.txt")
output2.disableAll()
